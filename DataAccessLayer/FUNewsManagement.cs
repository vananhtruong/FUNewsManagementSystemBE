...
public partial class FUNewsManagement : DbContext
{
    public FUNewsManagement()
    {
    }

    public FUNewsManagement(DbContextOptions<FUNewsManagement> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=LAPTOP-TVOTO8RG;Database=FUNewsManagement;User Id=sa;Password=12345;TrustServerCertificate=True;");
